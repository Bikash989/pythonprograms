...
tab3Frame = tk.Frame(tab3, bg = 'blue')
tab3Frame.pack()
for orange_color in range(2):
    canvas = tk.Canvas(tab3Frame, width = 150, height = 80, highlightthickness = 0, bg = 'orange')
    canvas.grid(row = orange_color, column = orange_color)  # coordinate 0,0 and 1,1
win.mainloop()
